...
import { clientLog } from '../utils/client-side-logging'
import type { AgentSession, Session, SendClientMessage, SubscribeServerMessage } from '@shared/shared-message-and-session-types'
import { useSessionStore, type ConnectionStatus } from '../stores/session-state-store'
import { useTerminal } from '../hooks/use-terminal-xterm-session'
import { useIsMobileLayout } from '../hooks/use-mobile-layout-detection'
import { useOnClickOutside } from '../hooks/use-click-outside-dismissal'
import { useEscapeToClose } from '../hooks/use-escape-key-dismissal'
import { useEdgeSwipeToOpenDrawer } from '../hooks/use-edge-swipe-drawer-gesture'
...
import { isIOSDevice, getEffectiveModifier, getModifierDisplay } from '../utils/device-detection-and-modifier-keys'
import TerminalControls from './mobile-terminal-control-buttons'
import SessionDrawer from './mobile-session-drawer'
