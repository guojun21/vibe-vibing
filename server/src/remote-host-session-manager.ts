import { inferAgentType, normalizePaneStartCommand } from './agent-type-detection-from-process'
...
import type { HostStatus, Session } from './shared/shared-message-and-session-types'
