import { TerminalProxyBase } from './abstract-terminal-proxy-base'
import { TerminalProxyError, TerminalState } from './terminal-proxy-type-definitions'
import { resolveGroupedSessionSwitchTarget } from './grouped-session-target-resolver'
