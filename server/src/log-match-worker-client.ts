import type { MatchWorkerRequest, MatchWorkerResponse } from './log-match-worker-message-types'

export type { MatchWorkerRequest, MatchWorkerResponse } from './log-match-worker-message-types'
...
export class LogMatchWorkerClient {
  ...
  private spawnWorker(): void {
    ...
    const workerPath = import.meta.url.includes('$bunfs')
      ? './log-match-background-worker.ts'
      : new URL('./log-match-background-worker.ts', import.meta.url).href
